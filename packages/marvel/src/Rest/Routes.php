...
use Marvel\Http\Controllers\ModelController;
use Marvel\Http\Controllers\ColorController;
use Marvel\Http\Controllers\GearController;
use Marvel\Http\Controllers\CreditController;
use Marvel\Http\Controllers\ProvinceController;
use Marvel\Http\Controllers\CaryearController;
...
Route::apiResource('caryear', CaryearController::class, [
    'only' => ['index', 'show'],
]);
